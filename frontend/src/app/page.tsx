      ...
      <div className="max-w-lg h-auto space-y-8 p-8 rounded-lg bg-[#f5fff6] shadow-lg">
        <div className="flex flex-col space-y-8">
          ...
          <div className="flex flex-row space-x-4 items-center">
            <div className="h-auto rounded-lg p-4 shadow-lg max-w-full w-1/2 break-words">
          ...
          <Link 
            href="/preferences"
            className="block w-full px-6 py-3 rounded-lg bg-[#aedab2] hover:scale-105 transition-all duration-200 text-center font-bold">
            Get Started
          </Link>
        </div>
      </div>
